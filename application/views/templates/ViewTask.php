...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
  ...
  <div class="pull-right">
    ...
    <a class="btn btn-success" href="<?php echo site_url('task/edit/incomplete') ?>">Selesai</a>
    <?php else: ?>
    <a class="btn btn-danger" href="<?php echo site_url('task/edit/complete') ?>">Belum Selesai</a>
    <a href="<?php echo site_url('task/edit/abandon') ?>" class="btn btn-warning">Drop</a>
    <?php endif; ?>
  </div>
  <?php endif; ?>
