...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
  <h1 class="page-header">Tugas <?php echo $nama_projek ?></h1>
  <div class="pull-left">
    <div class="meta">
      Projek dimulai pada  <?php echo date("d-m-Y H:i A", strtotime($tgl_dibuat)) ?>
    </div>
  </div>
  ...
  <article>
    ...
    <table class="table table-horizontal">
      <tr>
        <td>Durasi</td>
        <td>: 
        <?php if($this->verifystatus->dateDiff('d', date('Y-m-d H:i:s'), $tgl_deadline) <= 0): ?>
